    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {isOpen && (
        <div className="glass-panel mb-4 w-80 rounded-2xl overflow-hidden shadow-2xl flex flex-col animate-in fade-in slide-in-from-bottom-10 duration-300">
          ...
          <div className="h-64 bg-white/95 p-4 overflow-y-auto flex flex-col gap-3">
          ...
          <div className="p-3 bg-white border-t border-slate-100 flex gap-2">
            <input 
              ...
              className="flex-1 bg-slate-100 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accent/50"
            />
            <button className="bg-accent text-white p-2 rounded-full hover:bg-orange-600 transition-colors">
              <Send size={16} />
            </button>
          </div>
        </div>
      ...
      <button 
        ...
        className="bg-accent hover:bg-orange-600 text-white p-4 rounded-full shadow-lg shadow-orange-500/30 transition-all hover:scale-110 active:scale-95 group flex items-center gap-2"
      >
